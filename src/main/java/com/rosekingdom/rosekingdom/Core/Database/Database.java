...
public class Database {
    ...
    public static void createDatabaseTables(){
        ...
        Statement statement = connection.createStatement()) {
            ...
            statement.executeUpdate("CREATE TABLE IF NOT EXISTS rk_location(rowid int NOT NULL AUTO_INCREMENT, PRIMARY KEY(rowid), id int, name varchar(32), x int, y int, z int, public boolean, INDEX(id,public,name,x,y,z)))");
