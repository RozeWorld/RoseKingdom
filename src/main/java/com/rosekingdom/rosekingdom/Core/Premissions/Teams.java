package com.rosekingdom.rosekingdom.Core.Premissions;
...
public class Teams {
    ...
    public static void joinTeam(Player player, String team){
        ...
        attachment.unsetPermission("rk.owner");
        attachment.unsetPermission("rk.admin");
        attachment.unsetPermission("rk.mod");
        attachment.setPermission("rk." + team, true);
    }
}
